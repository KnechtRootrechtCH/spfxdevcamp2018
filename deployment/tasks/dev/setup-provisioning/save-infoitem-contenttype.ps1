...
$demo = $apps.default.url + "/sites/dev-g-O3"
...
$templateInformationFile = "C:\Projects\prive-0365\deployment\tasks\dev\setup-provisioning\information_contenttype-template.xml";
Get-PnPProvisioningTemplate -Out $templateInformationFile -Handlers Fields, ContentTypes -Force
